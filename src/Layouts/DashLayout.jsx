    ...
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side">
        ...
        <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4 space-y-1">
          ...
          >
            <h4 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">
              Node js
            </h4>
          </div>
          ...
          {role === "user" && (
            <>
              <li className="font-bold">
                ...
                >
                  <BsFileEarmarkText size={20} /> Add Post
                </NavLink>
              </li>
              <li className="font-bold">
                <NavLink
                ...
                >
                  <FaMoneyCheckAlt size={20} /> My Post
                </NavLink>
              </li>
            </>
          )}
